...
public class ChildKetQuaAdapter extends RecyclerView.Adapter<ChildKetQuaAdapter.MyViewHolder> {
    ...
    public ChildKetQuaAdapter(List<KetQua> list, boolean isKetQua) {
        this.list = list;
    ...
    @Override
    public ChildKetQuaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(isKetQua ? R.layout.item_child_ketqua : R.layout.item_lich_thi_dau, parent, false);
